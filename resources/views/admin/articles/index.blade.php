                ...
                <div
                    ...
                    <div class="flex p-6 justify-start">
                        <form action="" method="GET" class="flex space-x-4 w-full">
                          ...
                          <div class="flex-auto mr-4">
                            <label for="topic_id" class="block mb-2">Topic</label>
                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <a href="/admin/articles/{{ $article->slug }}"
                                                    ...
                                                    View </a>
                                                <a href="/admin/articles/{{ $article->slug }}/edit"
                                                    class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-blue-500">
                                                    Edit </a>
                                                <form action="/admin/articles/{{ $article->slug }}" method="post" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                            ...
                            <div>
                                {{ $articles->links('admin.pagination.default') }}
                            </div>
                        </div>
                    </div>
                </div>
